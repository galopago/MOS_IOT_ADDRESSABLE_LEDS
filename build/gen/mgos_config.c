 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.17.0/apps/MOS_IOT_ADDRESSABLE_LEDS/esp8266/build_contexts/build_ctx_122458588/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /data/fwbuild-volumes/2.17.0/apps/MOS_IOT_ADDRESSABLE_LEDS/esp8266/build_contexts/build_ctx_122458588/build/gen/mos_conf_schema.yml
 */
...
const struct mgos_conf_entry mgos_config_schema_[135] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 134},
